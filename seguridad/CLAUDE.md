...
Con esto, los pendientes de la sesión "seguro de la app" (obfuscación #7, hotfix del hash, CORS + bypass admin, automatización de hashes) quedaron todos cerrados y verificados.
