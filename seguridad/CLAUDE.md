...
8. ⏳ Pendiente: añadir el texto de `07-aviso-legal-derechos.md` (sección 1) en el footer o pantalla "Acerca de" de la app.
9. ⏳ Pendiente (verificación manual antes de producción): probar en un deploy preview de Netlify que el CSP no rompe nada (no se pudo probar acá porque no hay Netlify CLI instalado ni sitio linkeado en este entorno) — ver aviso al usuario en la conversación de integración.
